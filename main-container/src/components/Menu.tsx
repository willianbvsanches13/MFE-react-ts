...
const Menu = () => {
  ...
  return (
    <div
      className={`inset-y-0 w-64 left-0 z-30 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0`}
    >
